...
public class TVShowReviews {
    ...
    private int id;
    private int page;
    private List<TVShowReview> results;
    ...
    public List<TVShowReview> getResults() { return results; }
    public void setResults(List<TVShowReview> results) { this.results = results; }
